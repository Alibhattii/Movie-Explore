...
export default function Home({ favorites, onFavoriteToggle }) {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      {intro && (
        <div className="bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-12 sm:py-20">
      ...
      {intro && !trendingLoading && trendingMovies.length > 0 && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="mb-6 sm:mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">🔥 Trending Movies</h2>
            <p className="text-gray-600">The most popular movies this week</p>
          </div>
      ...
      {intro && !trendingLoading && trendingTV.length > 0 && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="mb-6 sm:mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">📺 Trending TV Shows</h2>
            <p className="text-gray-600">The most popular TV shows this week</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="flex items-center justify-center py-8 sm:py-12">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm sm:text-base text-gray-600">Loading trending content...</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        {loading && (
          <div className="flex items-center justify-center py-8 sm:py-12">
            <div className="flex items-center gap-3">
              <div className="w-5 h-5 sm:w-6 sm:h-6 border-2 border-indigo-600 border-t-transparent rounded-full animate-spin"></div>
              <span className="text-sm sm:text-base text-gray-600">Searching...</span>
            </div>
          </div>
        )}
        ...
        {empty && (
          <div className="text-center py-8 sm:py-12">
            ...
            <p className="text-sm sm:text-base text-gray-600">No movies or TV shows found for "{query}". Try a different search term.</p>
          </div>
        )}
        ...
        <div className="bg-white border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">About Us</h2>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 text-center">Technology Stack</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-2">TMDb API</h4>
