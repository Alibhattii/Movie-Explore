    ...
    <footer className="bg-white border-t border-gray-200 mt-12 sm:mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 sm:mb-4">Quick Links</h4>
            <ul className="space-y-2 text-sm">
              <li><a href="/" className="text-gray-600 hover:text-indigo-600 transition-colors">Home</a></li>
              <li><a href="/favorites" className="text-gray-600 hover:text-indigo-600 transition-colors">Favorites</a></li>
